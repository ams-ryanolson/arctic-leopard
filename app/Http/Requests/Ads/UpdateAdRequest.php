...
class UpdateAdRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'budget_amount' => ['sometimes', 'required', 'integer', 'min:1'],
            'budget_currency' => ['sometimes', 'required', 'string', 'size:3'],
            'pricing_model' => ['sometimes', 'required', Rule::enum(PricingModel::class)],
            'pricing_rate' => ['sometimes', 'required', 'integer', 'min:1'],
