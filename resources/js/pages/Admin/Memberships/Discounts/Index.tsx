...
export default function AdminDiscountsIndex({ discounts, plans: _plans }: AdminDiscountsIndexProps) {
    ...
    const handleDelete = (discount: Discount) => {
        ...
        router.delete(adminRoutes.memberships.discounts.destroy(discount.id).url, {
            preserveScroll: true,
        ...
        >
            ...
            <div className="space-y-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-white">Discount Codes</h1>
                        <p className="mt-2 text-sm text-white/70">
                            Manage discount codes for membership plans
                        </p>
                    </div>
                    <Button asChild>
                        <Link href={adminRoutes.memberships.discounts.create().url}>
                    ...
                    <CardContent className="p-0">
                        {discounts.length === 0 ? (
                            <div className="py-12 text-center">
                                ...
                                <h3 className="mt-4 text-lg font-semibold text-white">No discount codes</h3>
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1 space-y-2">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        {discount.description && (
                                                            <p className="text-sm text-white/60">{discount.description}</p>
                                                        )}
                                                    </div>
                                                </div>
                                                ...
                                                <div className="ml-8 grid gap-2 md:grid-cols-2 lg:grid-cols-4">
                                                    <div>
                                                        <p className="text-xs text-white/50">Discount Type</p>
                                                    ...
                                                    <div>
                                                        <p className="text-xs text-white/50">Applies To</p>
                                                        <p className="text-sm font-medium text-white">
                                                            {discount.plan ? discount.plan.name : 'All Plans'}
                                                        </p>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs text-white/50">Valid Period</p>
                                                        <p className="text-sm text-white/70">
                                                            {formatDate(discount.starts_at)} - {formatDate(discount.ends_at)}
                                                        </p>
                                                    </div>
                                                    <div>
                                                        <p className="text-xs text-white/50">Usage</p>
                                                        <p className="text-sm text-white/70">
                                                            {discount.used_count}
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    ...
                                                    asChild
                                                >
                                                    <Link href={adminRoutes.memberships.discounts.edit(discount.id).url}>
                                                        Edit
                                                    </Link>
                                                </Button>
                                                <Button
