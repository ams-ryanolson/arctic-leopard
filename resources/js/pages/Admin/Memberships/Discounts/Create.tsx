    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Create Discount', href: adminRoutes.memberships.discounts.create().url },
            ]}
        >
            ...
            <div className="space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-white">Create Discount Code</h1>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setData('discount_value', value ? Number.parseInt(value, 10) : 0);
                                        }}
                                        className="bg-white/5 border-white/10 text-white"
                                        placeholder={data.discount_type === 'percentage' ? '20' : '500'}
                                    />
                                    <p className="text-xs text-white/50">
