                ...
                <div className="space-y-1.5">
                    <div className="flex items-center gap-3">
                        ...
                        <Badge className="rounded-full border-white/20 bg-white/10 text-[0.65rem] tracking-[0.3em] text-white/70 uppercase">
                            {numberFormatter.format(circle.membersCount)}{' '}
                            members
                        </Badge>
                    </div>
                    {circle.tagline && (
...
export default function Profile({
    ...
    const selectedInterests = useMemo(
        () => new Set<number>(form.data.interests),
        [form.data.interests],
    );
    ...
    const addHashtag = (rawTag: string): void => {
        ...
        if (
            !normalized ||
            form.data.hashtags.includes(normalized) ||
    ...
    const removeHashtag = (tag: string): void => {
        form.setData(
            'hashtags',
            form.data.hashtags.filter((value) => value !== tag),
        );
    };
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white/65">
                                        Update your profile details and how
                                ...
                                <>
                                    ...
                                    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 text-white shadow-[0_42px_120px_-60px_rgba(249,115,22,0.55)] transition-all duration-300 hover:border-amber-400/30 hover:shadow-[0_50px_120px_-60px_rgba(249,115,22,0.65)]">
                                        ...
                                        <div className="relative space-y-5">
                                            <div className="flex items-center gap-3">
                                                <div className="flex items-center justify-center rounded-xl border border-amber-400/40 bg-gradient-to-br from-amber-400/30 to-amber-500/20 p-2.5 shadow-[0_12px_30px_-18px_rgba(249,115,22,0.65)]">
                                    ...
                                    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 text-white shadow-[0_32px_85px_-40px_rgba(249,115,22,0.45)] transition-all duration-300 hover:border-violet-400/30 hover:shadow-[0_40px_100px_-40px_rgba(124,58,237,0.55)]">
                                        ...
                                        <div className="relative space-y-5">
                                            <div className="flex items-center gap-3">
                                                <div className="flex items-center justify-center rounded-xl border border-violet-400/40 bg-gradient-to-br from-violet-400/30 to-violet-500/20 p-2.5 shadow-[0_12px_30px_-18px_rgba(124,58,237,0.65)]">
                                    ...
                                    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 text-white shadow-[0_32px_85px_-40px_rgba(59,130,246,0.45)] transition-all duration-300 hover:border-blue-400/30 hover:shadow-[0_40px_100px_-40px_rgba(59,130,246,0.55)]">
                                        ...
                                        <div className="relative space-y-5">
                                            <div className="flex items-center gap-3">
                                                <div className="flex items-center justify-center rounded-xl border border-blue-400/40 bg-gradient-to-br from-blue-400/30 to-blue-500/20 p-2.5 shadow-[0_12px_30px_-18px_rgba(59,130,246,0.65)]">
                                                        ...
                                                        (interest) => {
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    className={cn(
                                                                        'group relative rounded-2xl border px-5 py-4 text-left transition-all duration-200 focus:ring-2 focus:ring-amber-500/40 focus:outline-none',
                                                                        isSelected
                                    ...
                                    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 text-white shadow-[0_32px_85px_-40px_rgba(16,185,129,0.45)] transition-all duration-300 hover:border-emerald-400/30 hover:shadow-[0_40px_100px_-40px_rgba(16,185,129,0.55)]">
                                        ...
                                        <div className="relative space-y-5">
                                            <div className="flex items-center gap-3">
                                                <div className="flex items-center justify-center rounded-xl border border-emerald-400/40 bg-gradient-to-br from-emerald-400/30 to-emerald-500/20 p-2.5 shadow-[0_12px_30px_-18px_rgba(16,185,129,0.65)]">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                {form.data.hashtags.length >
                                                    0 && (
                                                    <div className="flex flex-wrap gap-2">
                                                        {form.data.hashtags.map(
                                                            (tag) => (
                                                                <span
                                                                    key={tag}
                        ...
                        <div className="relative space-y-6 p-6 sm:p-8">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white/65">
                                        Manage the communities you joined
                                        through onboarding
                                    </p>
                                </div>
                            </div>
                            ...
                            {circleMemberships.length === 0 ? (
                                <div className="rounded-2xl border border-white/10 bg-black/40 p-6 text-center text-sm text-white/70">
                                    <p>
                                        ...
                                        Select interests during onboarding or
                                        browse the{' '}
                                        <Link
