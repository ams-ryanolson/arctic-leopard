...
export default function AdminModerationIndex() {
    ...
    const normalizedQueue = useMemo(() => {
        const raw = props.queue as unknown as Partial<Paginated<QueueEntry>> &
            LegacyPaginator<QueueEntry>;
    ...
    const handleFilter = useCallback(() => {
        ...
        router.visit(
            adminRoutes.moderation.index().url +
                        ...
                        >
                            <div className="relative flex-1">
                                ...
                                <Input
                                    ...
                                    className="w-full border-white/10 bg-white/5 pl-10 text-white"
                                />
                            </div>
                            <Select
                                value={typeFilter}
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between gap-4">
                                        ...
                                        >
                                            <a
                                                href={
                                                    adminRoutes.moderation.show(
                                                        {
                                                            type: entry.content_type.toLowerCase(),
                                                            id: entry.content_id,
                                                        },
                                                    ).url
                                                }
