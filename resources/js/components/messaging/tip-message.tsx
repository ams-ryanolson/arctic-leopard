...
export default function TipMessage({
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between text-[0.65rem] tracking-[0.3em] uppercase">
                ...
                <Badge
                    variant="secondary"
                    className="rounded-full border border-white/20 bg-white/15 px-3 py-0.5 text-[0.6rem] tracking-[0.3em] text-white uppercase"
                >
            ...
            <p className="mt-4 text-[0.65rem] tracking-[0.25em] text-white/50 uppercase">
