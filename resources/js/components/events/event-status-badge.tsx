...
const toneClasses: Record<
    ReturnType<typeof eventStatusTone>,
    string
> = {
    success:
    ...
    danger:
        'border-rose-400/40 bg-rose-500/20 text-rose-200 shadow-[0_12px_28px_-18px_rgba(244,63,94,0.45)]',
    muted:
        'border-white/15 bg-white/10 text-white/65 shadow-[0_10px_22px_-16px_rgba(148,163,184,0.35)]',
};
