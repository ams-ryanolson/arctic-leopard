...
export default function MessageItem({
    ...
    return (
        <>
            <div
                className={cn(
                    'group relative flex gap-3 px-2 py-1.5 transition-colors hover:bg-white/[0.015]',
                    isOwnMessage ? 'flex-row-reverse' : 'flex-row',
                )}
                    ...
                    <div
                        className={cn(
                            ...
                            message.body && isOwnMessage
                                ? 'border border-emerald-500/20 bg-emerald-500/20 text-emerald-50 shadow-[0_2px_8px_rgba(16,185,129,0.15)]'
                                : message.body
