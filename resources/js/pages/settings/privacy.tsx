                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white/65">
                                        Control who can follow you and manage
                                        your blocked users
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div className="relative space-y-6 p-6 sm:p-8">
                                        <div className="rounded-2xl border border-white/10 bg-black/40 p-5">
                                            ...
                                            <InputError
                                                className="mt-3"
                                                message={
                                                    errors.requires_follow_approval
                                                }
                                            />
                                        </div>
                        ...
                        <div className="relative space-y-6 p-6 sm:p-8">
                            ...
                            <div className="rounded-2xl border border-white/10 bg-black/40 p-5">
                                <p className="mb-4 text-sm leading-relaxed text-white/70">
                                    Blocked users cannot see your posts, send
                                    you messages, or follow you. You can unblock
                                    users at any time.
                                </p>
                                <Button
                                    asChild
