...
export default function CookiesBanner({
    ...
    const doNotSellDefault = Boolean(
        (config as any)?.do_not_sell_default ?? false,
    );
    ...
    const [analytics, setAnalytics] = useState<boolean>(
        Boolean(defaults.analytics),
    );
    const [marketing, setMarketing] = useState<boolean>(
        Boolean(defaults.marketing),
    );
                ...
                <div className="flex items-start gap-3 border-b border-white/10 px-5 py-4">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-xs leading-5 text-white/60">
                            ...
                            analyze site usage, and if you agree, to customize
                            or personalize your experience and market our
                            services to you. You can read our Cookie Policy
                            here.
                        </p>
                    </div>
                    <button
                    ...
                    {expanded && (
                        <div id="cookie-details" className="mt-4">
                            <div className="mb-3 rounded-xl border border-white/10 bg-white/[0.03] p-3 text-[13px] text-white/80">
                                ...
                                other users of our website. This helps us
                                provide you with a more personalized experience
                                when you browse our website and also allows us
                                to improve our site. Cookies may collect
                                information that is used to tailor ads shown to
                                you on our website and other websites. The
                                information might be about you, your preferences
                                or your device. The information does not usually
                                directly identify you, but it can give you a
                                more personalized web experience. You can choose
                                not to allow some types of cookies.
                            </div>
                            <div className="grid gap-4 md:grid-cols-3">
                                <div
                                    className="rounded-xl border border-amber-400/40 bg-amber-400/10 p-3 text-left shadow-[0_0_0_1px_rgba(251,191,36,0.25)_inset] transition"
                                    aria-disabled="true"
                                >
                                    ...
                                    <p className="mt-1 text-xs text-white/65">
                                        Required for sign‑in, security, and core
                                        site features.
                                    </p>
                                </div>
                                <button
                                ...
                                >
                                    ...
                                    <p className="mt-1 text-xs text-white/65">
                                        Helps us understand usage to improve the
                                        product.
                                    </p>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <p className="mt-1 text-xs text-white/65">
                                        Used for personalization and partner
                                        tools.
                                    </p>
                                </button>
                                <button
                                    ...
                                    tabIndex={0}
                                    className={[
                                        'rounded-xl border p-3 text-left transition md:col-span-3',
                                        doNotSell
                                            ? 'border-amber-400/40 bg-amber-400/10 shadow-[0_0_0_1px_rgba(251,191,36,0.25)_inset]'
                                            : 'border-white/10 bg-white/[0.03] hover:bg-white/10',
                                    ].join(' ')}
                                >
                                    ...
                                    <p className="mt-1 text-xs text-white/65">
                                        ...
                                        Limited, anonymous data may be shared to
                                        measure performance and improve
                                        services. Enable this to opt out of any
                                        sharing used for targeted advertising.
                                    </p>
                                </button>
                                {services && services.length > 0 && (
                                    <div className="rounded-xl border border-white/10 bg-white/[0.02] p-3 md:col-span-3">
                                        <p className="text-xs font-semibold text-white">
