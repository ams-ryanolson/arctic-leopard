...
class LogAdClick implements ShouldQueue
{
    ...
    public function __construct(
        ...
        public ?AdImpression $impression = null,
    ) {}
    ...
    public function handle(AdPricingService $pricingService): void
    {
        ...
        $click = AdClick::create([
            ...
            'impression_id' => $this->impression?->getKey(),
        ...
        // Calculate cost and update spend (for CPC/CPA models)
        $cost = $pricingService->calculateCost($ad, 0, 1);
        if ($cost > 0) {
