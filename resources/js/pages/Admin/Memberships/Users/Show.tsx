...
export default function AdminUserMembershipShow({
    user,
    memberships,
    plans,
}: AdminUserMembershipShowProps) {
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                {
                    title: user.name,
                    href: adminRoutes.memberships.users.show(user.id).url,
                },
            ]}
        >
                ...
                <div className="flex items-center justify-between">
                    ...
                    >
                        ...
                        <DialogContent className="border-white/10 bg-neutral-950 text-white">
                            <DialogHeader>
                                <DialogTitle>
                                    Assign Membership to {user.name}
                                </DialogTitle>
                                <DialogDescription className="text-white/60">
                                    Manually assign a membership plan to this
                                    user. This will cancel any existing active
                                    membership.
                                </DialogDescription>
                            </DialogHeader>
                                ...
                                <div className="space-y-4 py-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-white/50">
                                            Leave empty to use plan default (30
                                            days for one-time, 30 days for
                                            recurring)
                                        </p>
