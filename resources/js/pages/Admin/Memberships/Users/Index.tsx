...
export default function AdminMembershipsUsersIndex({
    ...
    const normalizedMemberships = useMemo(() => {
        const raw = memberships as unknown as Partial<Paginated<UserMembership>> & {
            data?: UserMembership[];
            current_page?: number;
            per_page?: number;
            total?: number;
    ...
    return (
        ...
        >
            ...
            <div className="space-y-8">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white">User Memberships</h1>
                                ...
                                {(search || statusFilter || planFilter) && (
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            setStatusFilter('');
                                            setPlanFilter('');
                                            router.get(adminRoutes.memberships.users.index().url);
                                        }}
                                    >
                                        Clear
                                    </Button>
                    ...
                    <CardContent className="p-0">
                        {normalizedMemberships.data.length === 0 ? (
                            <div className="py-12 text-center">
                                ...
                                <h3 className="mt-4 text-lg font-semibold text-white">No memberships found</h3>
                            ...
                            <div className="divide-y divide-white/10">
                                {normalizedMemberships.data.map((membership) => (
                                    <div
                                        key={membership.id}
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1 space-y-2">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <Link
                                                            href={adminRoutes.memberships.users.show(membership.user.id).url}
                                                ...
                                                <div className="ml-8 grid gap-2 md:grid-cols-2 lg:grid-cols-3">
                                                    ...
                                                    {membership.next_billing_at && (
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-white/70">
                                                                {formatDistanceToNow(new Date(membership.next_billing_at), {
                                                                    addSuffix: true,
                                                                })}
                                                            </p>
                                                        </div>
