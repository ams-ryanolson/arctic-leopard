...
export function MobileBottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-white/10 bg-black/95 backdrop-blur-xl safe-area-inset-bottom">
                    ...
                    return (
                        ...
                        >
                            <div className="relative">
                                ...
                                {item.badge && (
                                    <span className="absolute -right-2 -top-2 flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[0.65rem] font-semibold text-white">
                                        {item.badge}
                                    </span>
                                )}
                            </div>
                            <span className="text-[0.65rem] font-medium">{item.title}</span>
                            {isActive && (
