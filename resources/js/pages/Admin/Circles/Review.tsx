...
export default function AdminCirclesReview({ suggestion, interests }: ReviewPageProps) {
    ...
    const handleCreate = () => {
        createForm.post(adminCirclesRoutes.suggestions.create(suggestion.id).url, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleDecline = () => {
        declineForm.post(adminCirclesRoutes.suggestions.decline(suggestion.id).url, {
            preserveScroll: true,
            onSuccess: () => {
                // Redirect handled by controller
            },
            ...
            <div className="space-y-6 text-white">
                <div className="flex items-center gap-4">
                    <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => router.visit(adminCirclesRoutes.index().url)}
                    ...
                    <div>
                        <h1 className="text-3xl font-semibold tracking-tight">Review Circle Suggestion</h1>
                        <p className="mt-2 text-sm text-white/65">Review and create a circle from this suggestion</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        <Card className="border-white/10 bg-black/40 text-white">
                            <CardHeader>
                                ...
                                <CardDescription>Details submitted by the user</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div>
                                    <Label className="text-xs uppercase tracking-wider text-white/55">Name</Label>
                                    <p className="mt-1 text-lg font-medium">{suggestion.name}</p>
                                </div>
                                {suggestion.description && (
                                    <div>
                                        <Label className="text-xs uppercase tracking-wider text-white/55">Description</Label>
                                        <p className="mt-1 text-sm text-white/75">{suggestion.description}</p>
                                    </div>
                                )}
                        ...
                        <Card className="border-white/10 bg-black/40 text-white">
                            <CardHeader>
                                ...
                                <CardDescription>Configure the circle settings</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => createForm.setData('interest_id', value)}
                                    >
                                        ...
                                        <SelectContent className="rounded-2xl border border-white/10 bg-black/85 text-white">
                                            {interests.map((interest) => (
                                                <SelectItem key={interest.id} value={String(interest.id)}>
                                                    {interest.name}
                                                </SelectItem>
                                            ))}
                                        </SelectContent>
                                    </Select>
                                    <InputError message={createForm.errors.interest_id} />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => createForm.setData('tagline', e.target.value)}
                                        placeholder="A short, catchy tagline"
                                        className="border-white/20 bg-black/40 text-white"
                                    />
                                    <InputError message={createForm.errors.tagline} />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => createForm.setData('visibility', value)}
                                    >
                                        <SelectTrigger className="border-white/20 bg-black/40 text-white">
                                            <SelectValue />
                                        </SelectTrigger>
                                    ...
                                    <InputError message={createForm.errors.visibility} />
                                </div>
                        ...
                        <Card className="border-white/10 bg-black/40 text-white">
                            ...
                            <CardContent className="space-y-4">
                                <Button
                                    ...
                                    disabled={createForm.processing || !createForm.data.interest_id}
                                ...
                                {!showDeclineForm ? (
                                    ...
                                    <div className="space-y-3 rounded-2xl border border-rose-400/20 bg-rose-500/10 p-4">
                                        <div className="space-y-2">
                                            <Label htmlFor="admin_notes" className="text-rose-100">
                                            ...
                                            />
                                            <InputError message={declineForm.errors.admin_notes} />
                                        </div>
