...
class StoryImageProcessor implements ImageProcessorInterface
{
    ...
    {
        // For stories, we optimize but don't resize the main image
        // The optimized version will be the full-size WebP conversion
        return $image;
    }
