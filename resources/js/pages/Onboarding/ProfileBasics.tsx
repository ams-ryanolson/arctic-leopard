...
export default function ProfileBasics({
    ...
    const { data, setData, errors, processing, transform, put } = useForm({
    ...
    const addHashtag = (rawTag: string): void => {
        ...
        if (
            !normalized ||
            data.hashtags.includes(normalized) ||
    ...
    const removeHashtag = (tag: string): void => {
        setData(
            'hashtags',
            data.hashtags.filter((value) => value !== tag),
        );
    };
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 px-4 py-6 text-white shadow-[0_42px_120px_-60px_rgba(249,115,22,0.55)] sm:px-6 sm:py-7">
                    ...
                    <div className="relative space-y-5 sm:space-y-6">
                        <div className="flex items-center gap-2 text-xs tracking-[0.35em] text-white/70 uppercase">
                                    ...
                                    <div className="space-y-4">
                                        <div className="relative py-2">
                                            ...
                                            <input
                                                ...
                                                className="relative h-1.5 w-full appearance-none bg-transparent outline-none [&::-moz-range-thumb]:h-6 [&::-moz-range-thumb]:w-6 [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white/20 [&::-moz-range-thumb]:bg-gradient-to-br [&::-moz-range-thumb]:from-amber-400 [&::-moz-range-thumb]:via-rose-500 [&::-moz-range-thumb]:to-violet-600 [&::-moz-range-thumb]:shadow-[0_4px_16px_rgba(249,115,22,0.6)] [&::-moz-range-thumb]:transition-all [&::-moz-range-thumb]:duration-200 [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white/20 [&::-webkit-slider-thumb]:bg-gradient-to-br [&::-webkit-slider-thumb]:from-amber-400 [&::-webkit-slider-thumb]:via-rose-500 [&::-webkit-slider-thumb]:to-violet-600 [&::-webkit-slider-thumb]:shadow-[0_4px_16px_rgba(249,115,22,0.6)] [&::-webkit-slider-thumb]:transition-all [&::-webkit-slider-thumb]:duration-200 [&::-webkit-slider-thumb]:hover:scale-125 [&::-webkit-slider-thumb]:hover:border-white/40 [&::-webkit-slider-thumb]:hover:shadow-[0_6px_20px_rgba(249,115,22,0.8)] [&::-webkit-slider-thumb]:active:scale-110"
                                            />
                                        </div>
                                ...
                                <div className="space-y-4 text-sm text-white/75 sm:space-y-4">
                                    <div>
                                        ...
                                        <p className="mt-1.5 text-sm leading-relaxed">
                                            This is what shows up across
                                            dashboards, search, and follow
                                            prompts. Choose a handle that feels
                                            safe and recognisable. You can
                                            change it later.
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <p className="mt-1.5 text-sm leading-relaxed">
                                            Setting pronouns helps others
                                            address you correctly in scenes and
                                            messages. Click a suggestion to
                                            auto-fill or type something custom.
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-xs font-medium tracking-[0.35em] text-white/60 uppercase">
                                        ...
                                        <p className="mt-1.5 text-sm leading-relaxed">
                                            Share how you identify. This helps
                                            others understand and respect your
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1.5 text-sm leading-relaxed">
                                            Indicate your preferred role on the
                                            spectrum from submissive to
                                            dominant. This helps match you with
                                            compatible partners and scenes.
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-xs font-medium tracking-[0.35em] text-white/60 uppercase">
                                        ...
                                        <p className="mt-1.5 text-sm leading-relaxed">
                                            Share what lights you up, what
                                            boundaries matter, and how people
                                            can collaborate with you. Highlight
                                            key points with bold or underline.
                                    ...
                                    <div>
                                        ...
                                        <ul className="mt-1.5 grid gap-2 text-sm leading-relaxed">
                    ...
                    <div className="relative space-y-5 sm:space-y-6">
                        <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-2 text-xs tracking-[0.35em] text-white/70 uppercase">
                                ...
                                {maxInterestSelections})
                            </div>
                        </div>
                        <p className="text-sm leading-relaxed text-white/75 sm:text-base">
                            Choose up to {maxInterestSelections} focus areas.
                            These help power recommendations and who we
                            introduce you to first.
                        </p>
                        {limitReached && (
                            <p className="text-sm font-semibold text-amber-300 sm:text-base">
                                You've reached the maximum of{' '}
                                {maxInterestSelections} interests. Remove one to
                                add another.
                            </p>
                        )}
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 sm:gap-4 xl:grid-cols-3">
                            {interests.map((interest) => {
                                const isSelected = selectedInterests.has(
                                    interest.id,
                                );
                                ...
                                return (
                                    <button
                                        ...
                                        className={cn(
                                            'group relative rounded-2xl border px-5 py-4 text-left transition-all duration-200 focus:ring-2 focus:ring-amber-500/40 focus:outline-none sm:px-6 sm:py-5',
                                            isSelected
                                                ? 'border-amber-400/80 bg-gradient-to-br from-amber-400/15 to-amber-400/5 shadow-[0_24px_55px_-30px_rgba(249,115,22,0.65)] hover:scale-[1.02] hover:border-amber-400/90 hover:shadow-[0_28px_65px_-25px_rgba(249,115,22,0.75)]'
                                                : 'border-white/20 bg-white/5 hover:scale-[1.01] hover:border-white/35 hover:bg-white/10',
                                        )}
                                    >
                                        {isSelected && (
                                            <div className="absolute top-3 right-3 flex h-5 w-5 items-center justify-center rounded-full bg-amber-400/20">
                                        ...
                                        {interest.description && (
                                            <p
                                                className={cn(
                                                    ...
                                                    isSelected
                                                        ? 'text-white/80'
                                                        : 'text-white/70 group-hover:text-white/75',
                                                )}
                                            >
                                                {interest.description}
                                            </p>
                    ...
                    <div className="relative space-y-5 sm:space-y-6">
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <p className="text-sm leading-relaxed text-white/70 sm:text-right sm:text-base">
                                Hashtags are discoverable—add unique niches or
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/5 px-4 py-3 transition-all focus-within:border-white/35 focus-within:bg-white/10">
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    variant="ghost"
                                    className="rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-medium text-white transition-all hover:border-white/35 hover:bg-white/15 hover:text-white disabled:cursor-not-allowed disabled:opacity-40"
                            ...
                            {data.hashtags.length >= maxHashtags && (
                                <p className="text-xs font-medium text-amber-300">
                                    You've reached the maximum of {maxHashtags}{' '}
                                    hashtags. Remove one to add another.
                                </p>
                            )}
                            <InputError
                                message={
                                    errors.hashtags ?? errors['hashtags.0']
                                }
                            />
                        </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {suggestedHashtags.map((tag) => (
                                    <button
                                        ...
                                        className="rounded-full border border-white/20 bg-white/10 px-3 py-1.5 text-xs font-medium text-white/80 transition-all hover:border-white/35 hover:bg-white/15 hover:text-white disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:border-white/20 disabled:hover:bg-white/10"
                                    >
                                        #{tag.name}
                                    </button>
                                ))}
                                {suggestedHashtags.length === 0 && (
                                    <span className="text-sm text-white/65">
                                        You've added every trending tag we
                                        suggested.
                                    </span>
                                )}
                            </div>
